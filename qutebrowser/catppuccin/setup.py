...
def setup(c, flavour, samecolorrows = False):
    ...
    c.colors.statusbar.command.fg = palette["red"]
    ...
    c.colors.tabs.bar.bg = palette["mantle"]
    ...
    c.colors.tabs.even.fg = palette["mantle"]
    ## Foreground color of unselected odd tabs.
    c.colors.tabs.odd.fg = palette["mantle"]
    ...
    c.colors.tabs.indicator.start = palette["yellow"]   # início do load
    c.colors.tabs.indicator.stop = palette["green"]    # fim do load
    c.colors.tabs.indicator.error = palette["red"]     # erro no load
    # }}}
